        ...
        <table class="table table-striped table-bordered table-hover1  table-condensed">
            ...
            <c:forEach items="${os}" var="o">
                <tr>
                    ...
                    <td align="center">${o.userDo.name}</td>
                        ...
                        <div  class="orderPageOrderItem">
                            <table width="800px" align="center" class="orderPageOrderItemTable">
                                <c:forEach items="${o.orderItemDos}" var="oi">
                                    <tr>
                                        <td align="left">
                                            <img width="40px" height="40px" src="img/productSingle/${oi.productDo.firstProductImage.id}.jpg">
                                        </td>

                                        <td>
                                            <a href="foreproduct?pid=${oi.productDo.id}">
                                                <span>${oi.productDo.name}</span>
                                            </a>
                                        </td>
                                        <td align="right">
                                        ...
                                        <td align="right">
                                            ...
                                            <span class="text-muted">单价：￥${oi.productDo.promotePrice}</span>
                                        </td>

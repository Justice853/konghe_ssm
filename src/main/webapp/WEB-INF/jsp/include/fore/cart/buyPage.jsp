            ...
            <table class="productListTable">
                ...
                <tr>
                    <th colspan="2" class="productListTableFirstColumn">
                        ...
                        <a class="marketLink" href="#nowhere">店铺：空盒店铺</a>
                ...
                <c:forEach items="${ois}" var="oi" varStatus="st" >
                    <tr class="orderItemTR">
                        <td class="orderItemFirstTD"><img class="orderItemImg" src="img/productSingle_middle/${oi.productDo.firstProductImage.id}.jpg"></td>
                        <td class="orderItemProductInfo">
                            <a  href="foreproduct?pid=${oi.productDo.id}" class="orderItemProductLink">
                                    ${oi.productDo.name}
                            </a>
                        ...
                        <td>
                            ...
                            <span class="orderItemProductPrice">￥<fmt:formatNumber type="number" value="${oi.productDo.promotePrice}" minFractionDigits="2"/></span>
                        </td>
                        <td>
                            <span class="orderItemProductNumber">${oi.number}</span>
                        </td>
                        <td><span class="orderItemUnitSum">
                        ￥<fmt:formatNumber type="number" value="${oi.number*oi.productDo.promotePrice}" minFractionDigits="2"/>
                        </span></td>

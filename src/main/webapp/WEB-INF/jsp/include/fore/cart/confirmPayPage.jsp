...
<div class="confirmPayPageDiv">
    ...
    <div class="confirmPayOrderItemDiv">
        ...
        <table class="confirmPayOrderItemTable">
            ...
            <c:forEach items="${o.orderItemDos}" var="oi">
                <tr>
                    <td><img width="50px" src="img/productSingle_middle/${oi.productDo.firstProductImage.id}.jpg"></td>
                    <td class="confirmPayOrderItemProductLink">
                        <a href="#nowhere">${oi.productDo.name}</a>
                    </td>
                    <td>￥<fmt:formatNumber type="number" value="${oi.productDo.originalPrice}" minFractionDigits="2"/></td>
                    <td>1</td>
                    <td><span class="conformPayProductPrice">￥<fmt:formatNumber type="number" value="${oi.productDo.promotePrice}" minFractionDigits="2"/></span></td>
    ...
    <div class="confirmPayOrderDetailDiv">
        ...
        <table class="confirmPayOrderDetailTable">
            ...
            <tr>
                <td>卖家昵称：</td>
                <td>空盒商铺 <span class="confirmPayOrderDetailWangWangGif"></span></td>
            </tr>
            <tr>
                <td>收货信息： </td>
